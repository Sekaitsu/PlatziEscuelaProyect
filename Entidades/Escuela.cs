namespace Event1.Entidades
{
    class clsEscuela
    {
        ...
        public clsEscuela(string nombre, int year)/*se asigna el nombre y el año a las propiedades Nombre , YearCreacion son iguales a los parametros nombre y year*/
        {
